...
UPDATE command SET help='Syntax: .cheat status\n Zeigt den aktuellen Status euerer cheats.' WHERE name='cheat status';
UPDATE command SET help='Syntax: .cheat god on/off\n Setzt den "Gott-Modus" (unverletzbar) für euch (on) oder hebt ihn auf (off).' WHERE name='cheat god';
UPDATE command SET help='Syntax: .cheat casttime on/off\n Setzt den Zauberzeit-Cheat für euch (on, alle Zauber wirken sofort) oder hebt ihn auf (off, Zauber brauchen normale Zeit).' WHERE name='cheat casttime';
UPDATE command SET help='Syntax: .cheat cooldown on/off\n Setzt den Cooldown-Cheat für euch (on, Zauber haben keinen cooldown) oder hebt ihn auf (off, Zauber haben normalen cooldown).' WHERE name='cheat cooldown';
UPDATE command SET help='Syntax: .cheat power on/off\n Setzt den Zauberkosten(Mana etc.)-Cheat für euch (on, Zauber verbrauchen kein Mana etc.) oder hebt ihn auf (off, Zauber haben normalen Verbrauch).' WHERE name='cheat power';
UPDATE command SET help='Syntax: .cheat explore $flag\n Deckt alle Karten für den ausgewählten Spieler auf ($flag=1) oder versteckt sie für Ihn ($flag=0). Wenn kein Spieler angewählt ist, versteckt oder deckt er alle Karten für euch auf.' WHERE name='cheat explore';
UPDATE command SET help='Syntax: .cheat taxi on/off\n Gewährt befristeten Zugriff auf alle Flugrouten oder entfernt diesen vom angewählten Charakter. Falls kein Charakter angewählt ist, werden alle Routen für Euch versteckt oder freigegeben.\n Bereits besuchte Flugpunkte sind nach der Zugriffszurücknahme weiterhin zugänglich.' WHERE name='cheat taxi';
UPDATE command SET help='Syntax: .cheat waterwalk on/off\n Setzt den "Jesus-Modus" (Auf-dem-Wasser-Laufen-Können) für den angewählten Spieler (on) oder hebt ihn auf (off).' WHERE name='cheat waterwalk';
...
UPDATE command SET help='Syntax: .lfg player\n Gibt Informationen über den Dungeonfinder-Status des Spielers aus (Status, Rollen, Kommentar, ausgewählte Dungeons).' WHERE name='lfg player';
UPDATE command SET help='Syntax: .lfg group\n Gibt Informationen über den Dungeonfinder-Status aller Spieler der Gruppe aus (Status, Rollen, Kommentar, ausgewählte Dungeons).' WHERE name='lfg group';
UPDATE command SET help='Syntax: .lfg queue\n Gibt Informationen über die aktuellen Dungeonfinder-Warteschlangen aus.' WHERE name='lfg queue';
UPDATE command SET help='Syntax: .lfg clean\n Löscht die aktuellen Dungeonfinder-Warteschlange. (Nur für Debug-Zwecke verwenden)' WHERE name='lfg queue';
UPDATE command SET help='Syntax: .lfg options [new value]\n Zeigt die aktuellen Dungeonfinder-Optionen, oder setzt sie auf [new value].' WHERE name='lfg options';
...
UPDATE command SET help='Syntax: .lookup spell id $spellid\n Sucht nach einen Zauber (Spell) mit der ID #spellid und gibt den Namen des Zauber aus.' WHERE name='lookup spell id';
...
UPDATE command SET help='Syntax: .modify arenapoints $value\n Fügt die Anzahl $amount an Arenapunkten dem angewählten Spieler hinzu.' WHERE name='modify arenapoints';
...
UPDATE command SET help='Syntax: .modify talentpoints $amount\n Ändert die freien Talentpunkte für den angewählten Spieler oder das angewählte Spieler-Pet um $amount. Der Wert wird beim nächsten levelup/login/Quest-Belohnung wird auf den default gesetzt.' WHERE name='modify talentpoints';
...
UPDATE command SET help='Syntax: .morph $displayid\n Ändert Euer derzeitiges Aussehen zu $displayid.' WHERE name='morph';
...
UPDATE command SET help='Syntax: .npc set data $field $data\n Ändert Daten der ausgewählten Kreatur. Wird für das Testen von Scripten verwendet.' WHERE name='npc set data';
...
UPDATE command SET help='Syntax: .quest reward $quest_id\n Gibt dem Spieler die Quest-Belohnung und entfernt die Quest $quest_id aus dem Quest-Log. (Aktion wie abgeben, die Quest muss abgeschlossen sein)' WHERE name='quest reward';
...
UPDATE command SET help='Syntax: .server set loglevel $facility $name $loglevel\n Folgende Werte sind zulässig:\n  für $facility: appender (a) oder logger (l)\n  für $name: Name des appenders bzw. des loggers\n  für $loglevel: disabled (0), trace (1), debug (2), info (3), warn (4), error (5) oder fatal (6)' WHERE name='server set loglevel';
...
UPDATE command SET help='Syntax-Normaler Spieler: .unstuck\n Teleportiert Euch in die Startregion Eures Charakters.\nSyntax-GM: .unstuck $playername [inn/graveyard/startzone]\n Teleportiert den Spieler $player an den angegebenen Ort (Default ist Ort des Ruhesteins).' WHERE name='unstuck';
