...
SET @GUIDS = 57954;
SET @GUID_GRIZZLEMAW_TRIGGER_1 = 57954;
SET @GUID_GRIZZLEMAW_TRIGGER_2 = 57963;
SET @GUID_GRIZZLEMAW_TRIGGER_3 = 57964;

UPDATE `creature_template` SET `AIName`='',`ScriptName`='npc_grizzlemaw_cw_trigger',`flags_extra`=0 WHERE `entry`=36209;

-- Elder Kekek
SET @GUID_KEKEK = 51439;
...
SET @GUID_SNOWFALL_GLADE_PLAYMATE = 51565;
...
-- Winterfin Playmate
SET @GUID_WINTERFIN_PLAYMATE = 51569;
...
-- Biggest Tree Ever
SET @GUID_BIGGEST_TREE_TRIGGER = 51576;
...
-- NPC areatriggers
SET @GUID_AERIS_LANDING_TRIGGER = 51593;
SET @GUID_SILVERMOON_TRIGGER_01 = 51601;
SET @GUID_AUCHINDOUN_TRIGGER = 51612;
SET @GUID_SPOREGGAR_TRIGGER = 51615;
SET @GUID_THRONE_OF_ELEMENTS_TRIGGER = 51622;
